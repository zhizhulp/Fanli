...
public class AddressPicker extends LinkagePicker {
    ...
    public void onSubmit() {
        if (onAddressPickListener != null) {
            ...
            Province.City.District county = null;
            if (!hideCounty) {
    ...
    public interface OnAddressPickListener {
         ...
         */
        void onAddressPicked(Province province, Province.City city, Province.City.District county);
    ...
    public static class AddressProvider implements DataProvider {
        ...
        private void parseData(List<Province> data) {
            ...
            for (int x = 0; x < provinceSize; x++) {
                ...
                List<Province.City> cities = pro.getCitys();
                ...
                for (int y = 0; y < citySize; y++) {
                    ...
                    List<Province.City.District> counties = cit.getDistricts();
                    ...
                    if (countySize == 0) {
                        ...
                        for (int z = 0; z < countySize; z++) {
                            Province.City.District cou = counties.get(z);
