...
public class WXPayEntryActivity extends Activity implements IWXAPIEventHandler, MoneyBar.CallBack {
    ...
    public static final int TYPE_PAY=2;//商城支付
    ...
    public void onResp(BaseResp resp) {
        Log.d("WXPayEntryActivity", "errCode:" + resp.errCode + "   errStr:" + resp.errStr + "   transaction:" + resp.transaction + "    openId" + resp.openId);
        int type=resp.getType();
        Log.d("WXPayEntryActivity", "type:" + type);
