...
public class AccountRechargeWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback, View.OnClickListener {
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(AccountRechargeWorkActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        try {
                            ...
                            Intent intent = new Intent(AccountRechargeWorkActivity.this, RechaSuccActivity.class);
    ...
    private void initViews() {
        ...
        moneyBar.setCallBack(new MoneyBar.CallBack() {
            ...
            public void clickComplete(View tv) {
                TransactionRecordsWorkActivity.startIntent(AccountRechargeWorkActivity.this);
            }
        });
    ...
    private void requestForAli(final String payInfo) {
        ...
        Runnable payRunnable = new Runnable() {
            @Override
            public void run() {
                PayTask alipay = new PayTask(AccountRechargeWorkActivity.this);
