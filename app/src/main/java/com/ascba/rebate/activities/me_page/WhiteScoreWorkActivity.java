...
import com.ascba.rebate.activities.me_page.white_score_child.WSExchangeWorkActivity;
 ...
 * 财富-白积分
 */
public class WhiteScoreWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
    ...
    private void initViews() {
        ...
        moneyBar.setCallBack(new MoneyBar.CallBack() {
            ...
            public void clickComplete(View tv) {
                TransactionRecordsWorkActivity.startIntent(WhiteScoreWorkActivity.this);
            }
        });
        ...
        wta.setCallback(new WhiteTicketAdapter.Callback() {
            ...
            public void onExchangeClick(int position) {
                ...
                Intent intent = new Intent(WhiteScoreWorkActivity.this, WSExchangeWorkActivity.class);
