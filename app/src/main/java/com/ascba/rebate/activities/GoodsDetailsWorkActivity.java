...
public class GoodsDetailsWorkActivity extends BaseNetWorkActivity implements View.OnClickListener
    ...
    public static void startIntent(Context context, int goodsId) {
        Intent intent = new Intent(context, GoodsDetailsWorkActivity.class);
    ...
    private void getdata() {
        ...
        setCallback(new Callback() {
            ...
            public void handle200Data(JSONObject dataObj, String message) {
                LogUtils.PrintLog("GoodsDetailsWorkActivity", "json-->" + dataObj);
    ...
    private void InitView() {
        ...
        evFirstBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, AllEvaluationWorkActivity.class);
        ...
        shopEnter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, BusinessShopWorkActivity.class);
        ...
        switch (v.getId()) {
            case R.id.btn_cart:
                ...
                if (AppConfig.getInstance().getInt("uuid", -1000) != -1000) {
                    ...
                    Intent intent = new Intent(this, LoginWorkActivity.class);
            ...
            case R.id.det_tv_shop://进入店铺
                Intent intent = new Intent(this, BusinessShopWorkActivity.class);
                intent.putExtra("store_id", goods.getStoreId());
                startActivity(intent);
                break;
            ...
            case R.id.goods_details_choose_rl:
                ...
                if (AppConfig.getInstance().getInt("uuid", -1000) != -1000) {
                    ...
                    Intent intent2 = new Intent(this, LoginWorkActivity.class);
            ...
            case R.id.abar_im_cart:
                //购物车
                ShopWorkActivity.setIndex(ShopWorkActivity.CART);
                finish();
                break;
        }
    }
    ...
    private void selectSpecification() {
        if(has_spec==0){//无规格
            ...
            setCallback(new Callback() {
                @Override
                public void handle200Data(JSONObject dataObj, String message) {
                    Log.d("GoodsDetailsWorkActivity", dataObj.toString());
    ...
    private void showStandardDialog(List<GoodsAttr> gas, List<Goods> goodses) {
            ...
            public void onClick(View v) {//加入购物车
                if (isAll) {//选择了完整的规格
                    if (AppConfig.getInstance().getInt("uuid", -1000) != -1000) {
                        ...
                        Intent intent = new Intent(GoodsDetailsWorkActivity.this, LoginWorkActivity.class);
        ...
        sd.setListener(new StdDialog.Listener() {
            ...
            public void isSelectAll(boolean isAll) {
                GoodsDetailsWorkActivity.this.isAll = isAll;
            }
        });
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        if (finalScene == 0) {
            ...
            Intent intent = new Intent(this, ConfirmOrderWorkActivity.class);
