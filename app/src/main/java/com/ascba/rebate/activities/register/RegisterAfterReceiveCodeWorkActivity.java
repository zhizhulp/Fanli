...
public class RegisterAfterReceiveCodeWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
...
//        obServeSms();//短信自动获取
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        ...
        Intent intent=new Intent(RegisterAfterReceiveCodeWorkActivity.this, LoginWorkActivity.class);
