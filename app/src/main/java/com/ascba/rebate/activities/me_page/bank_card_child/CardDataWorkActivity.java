...
public class CardDataWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        Intent intent=new Intent(CardDataWorkActivity.this,RealNameSuccessWorkActivity.class);
