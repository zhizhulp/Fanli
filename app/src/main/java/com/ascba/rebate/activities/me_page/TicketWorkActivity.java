...
public class TicketWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback,View.OnClickListener {
    ...
    private void initViews() {
        ...
        moneyBar.setCallBack(new MoneyBar.CallBack() {
            ...
            public void clickComplete(View tv) {
                TransactionRecordsWorkActivity.startIntent(TicketWorkActivity.this);
            }
        });
    ...
    public void onClick(View v) {
        Intent intent=new Intent(this,RedScoreUpdateWorkActivity.class);
