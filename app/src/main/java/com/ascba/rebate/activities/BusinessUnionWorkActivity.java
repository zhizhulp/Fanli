...
public class BusinessUnionWorkActivity extends BaseNetWorkActivity implements SuperSwipeRefreshLayout.OnPullRefreshListener, View.OnClickListener
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.business_account:
                //流水记录
                Intent intent=new Intent(this,BusiFlowRecordsWorkActivity.class);
                startActivity(intent);
                break;
            case R.id.business_data:
                //商家资料
                //getData();
                Intent intent1 = new Intent(context, BusinessDataWorkActivity.class);
