...
import com.ascba.rebate.activities.GoodsListWorkActivity;
...
public class TypeMarketWorkActivity extends BaseNetWorkActivity implements
        SuperSwipeRefreshLayout.OnPullRefreshListener, BaseNetWorkActivity.Callback {
    ...
    public static void startIntent(Context context, int id) {
        Intent intent = new Intent(context, TypeMarketWorkActivity.class);
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (data.size() != 0) {
                    if (shopBaseItem.getItemType() == ShopItemType.TYPE_GOODS) {
                        GoodsDetailsWorkActivity.startIntent(TypeMarketWorkActivity.this, shopBaseItem.getColor());
                    } else if (shopBaseItem.getItemType() == ShopItemType.TYPE_NAVIGATION) {
                        Intent intent = new Intent(TypeMarketWorkActivity.this, GoodsListWorkActivity.class);
