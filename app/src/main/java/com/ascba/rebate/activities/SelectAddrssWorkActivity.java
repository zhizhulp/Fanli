...
public class SelectAddrssWorkActivity extends BaseNetWorkActivity {
    ...
    private void initUI() {
        ...
        shopbar.setCallback(new ShopABarText.Callback() {
            ...
            public void clkBtn(View v) {
                Intent intentAddress = new Intent(context, ReceiveAddressWorkActivity.class);
            ...
            public void onSimpleItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    ...
                    case R.id.item_select_address_edit:
                        //编辑
                        Intent intent2 = new Intent(context, EditAdressWorkActivity.class);
