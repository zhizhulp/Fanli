...
public class MessageLatestWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback, SuperSwipeRefreshLayout.OnPullRefreshListener {
    ...
    private void requstData() {
        ...
        request = buildNetRequest(UrlUtils.moreNews, 0, false);
    ...
    public static void startIntent(Context context) {
        Intent intent = new Intent(context, MessageLatestWorkActivity.class);
