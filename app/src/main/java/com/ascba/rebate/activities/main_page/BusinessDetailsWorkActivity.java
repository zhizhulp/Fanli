...
public class BusinessDetailsWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
    // 起点位置
    ...
    public void goDescription(View view) {
        if(!"".equals(seller_description)){
            Intent intent=new Intent(this,ShowDescriptionWorkActivity.class);
    ...
    public void handle200Data(JSONObject dataObj, String message)   {
        ...
        Picasso.with(BusinessDetailsWorkActivity.this).load(UrlUtils.baseWebsite+seller_image).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE)
    ...
    public void showDialog() {
        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                OpenClientUtil.getLatestBaiduMapApp(BusinessDetailsWorkActivity.this);
            }
        });
