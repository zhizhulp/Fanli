 ...
 * 财富——红积分
 */
public class RedScoreUpdateWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
    ...
    private void initViews() {
        ...
        moneyBar.setCallBack(new MoneyBar.CallBack() {
            ...
            public void clickComplete(View tv) {
                TransactionRecordsWorkActivity.startIntent(RedScoreUpdateWorkActivity.this);
            }
        });
    ...
    public void redChange(View view) {
        ...
        dm.setCallback(new DialogManager.Callback() {
            ...
            public void handleSure() {
                ...
                executeNetWork(request, "请稍后");
                setCallback(RedScoreUpdateWorkActivity.this);
            }
        });
    }
