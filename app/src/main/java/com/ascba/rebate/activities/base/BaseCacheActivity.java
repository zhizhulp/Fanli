 ...
 * 带缓存功能
 */
public class BaseCacheActivity extends AppCompatActivity {
    ...
    private class NetResponseListener implements OnResponseListener<JSONObject> {
        ...
        public void onSucceed(int what, Response<JSONObject> response) {
            ...
            try {
                ...
                if (status == 200) {
                    ...
                    Intent intent = new Intent(BaseCacheActivity.this, LoginActivity.class);
        ...
        public void onFailed(int what, Response<JSONObject> response) {
            ...
            if (exception instanceof NetworkError) {
                boolean netAva = NetUtils.isNetworkAvailable(BaseCacheActivity.this);
                if (!netAva) {
