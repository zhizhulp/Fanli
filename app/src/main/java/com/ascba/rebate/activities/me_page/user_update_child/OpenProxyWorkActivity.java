package com.ascba.rebate.activities.me_page.user_update_child;
...
import com.ascba.rebate.activities.message.MessageWorkActivity;
...
public class OpenProxyWorkActivity extends BaseNetWorkActivity implements
    ...
    public void leaveMsg(View view) {
        Intent intent=new Intent(this,MessageWorkActivity.class);
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        if(finalScene==0){//页面数据获取
            ...
            //dm.buildAlertDialog(message);
            Intent intent=new Intent(this,UserUpdateWorkActivity.class);
            startActivity(intent);
            finish();
        }
    }
