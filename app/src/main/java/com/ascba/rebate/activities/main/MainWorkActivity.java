...
import static com.ascba.rebate.activities.shop.ShopWorkActivity.CART;


/**
 * 主界面
 */
public class MainWorkActivity extends BaseNetWorkActivity implements AppTabs.Callback {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_CANCELED && (requestCode == REQUEST_LOGIN_ME || requestCode == REQUEST_LOGIN_CAIFU)) {
            Log.d("MainWorkActivity", "currIndex:" + currIndex);
            ...
            switch (code) {
                ...
                case 6002://失败，重试
                    if (ExampleUtil.isConnected(getApplicationContext())) {
                        ...
                        Toast.makeText(MainWorkActivity.this, "网络异常", Toast.LENGTH_SHORT).show();
                    }
                    break;
                default:
            }
    ...
    public void clickTwo(View v) {
        currIndex = SHOP;
        Intent intent = new Intent(this, ShopWorkActivity.class);
