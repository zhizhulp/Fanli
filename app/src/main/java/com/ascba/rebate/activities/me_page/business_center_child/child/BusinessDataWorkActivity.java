...
public class BusinessDataWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
    ...
    public void goBusinessName(View view) {
        if(btnEnable.equals("0") ||btnEnable.equals("1")){
            Intent intent=new Intent(this,BusinessNameWorkActivity.class);
            if(seller_name!=null){
    ...
    public void goBusinessTag(View view) {
        if(btnEnable.equals("0") ||btnEnable.equals("1")){
            ...
            Intent intent=new Intent(this,BusinessTagWorkActivity.class);
    ...
    public void goBusinessPhone(View view) {
        if(btnEnable.equals("0") ||btnEnable.equals("1")){
            Intent intent=new Intent(this,BusinessPhoneWorkActivity.class);
            if(seller_tel!=null){
    ...
    public void goBusinessRate(View view) {
        if(btnEnable.equals("0") ||btnEnable.equals("1")){
            Intent intent=new Intent(this,EmployeeRateWorkActivity.class);
    ...
    public void goBusinessDetail(View view) {
        if(btnEnable.equals("0") ||btnEnable.equals("1")){
            Intent intent=new Intent(this,BusinessDescriptionWorkActivity.class);
            if(desc!=null){
        ...
        if(type==0){//显示店招pop
            ...
            sm.setCallback(new SelectIconManager.Callback() {
                ...
                public void clickCamera() {
                    ...
                    if(Build.VERSION.SDK_INT>23){//处理7.0的情况
                        Uri uri = FileProvider.getUriForFile(BusinessDataWorkActivity.this, "com.ascba.rebate.provider", file);
            ...
            sm.setCallback(new SelectIconManager.Callback() {
                ...
                public void clickCamera() {
                    ...
                    if(Build.VERSION.SDK_INT>23){//处理7.0的情况
                        Uri uri = FileProvider.getUriForFile(BusinessDataWorkActivity.this, "com.ascba.rebate.provider", fileLogo);
                        intent.putExtra(MediaStore.EXTRA_OUTPUT, uri);
