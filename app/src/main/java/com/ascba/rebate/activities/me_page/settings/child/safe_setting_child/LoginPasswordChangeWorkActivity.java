...
public class LoginPasswordChangeWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        Toast.makeText(LoginPasswordChangeWorkActivity.this, message, Toast.LENGTH_SHORT).show();
