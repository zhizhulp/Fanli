...
public class PlayVideoWorkActivity extends BaseNetWorkActivity implements SuperPlayer.OnNetChangeListener {
    ...
    public static void newIndexIntent(Context context, String message) {
        Intent newIntent = new Intent(context, PlayVideoWorkActivity.class);
