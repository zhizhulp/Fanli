...
public class BankCardWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        if(finalScene==0){
            Intent intent=new Intent(BankCardWorkActivity.this,CardWorkActivity.class);
