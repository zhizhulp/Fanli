...
public class PayDetailsWorkActivity extends BaseNetWorkActivity implements SuperSwipeRefreshLayout.OnPullRefreshListener, View.OnClickListener, BaseNetWorkActivity.Callback {
    ...
    private void getGoodsInfo(JSONObject dataObject) {
        try {
            ...
            if (!isCountdown) {
                ...
                Log.d("PayDetailsWorkActivity", "isCountdown:" + isCountdown);
            }
