...
public class ConfirmOrderWorkActivity extends BaseNetWorkActivity implements SuperSwipeRefreshLayout.OnPullRefreshListener, View.OnClickListener {
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(ConfirmOrderWorkActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        try {
                            ...
                            /*Intent intent = new Intent(ConfirmOrderWorkActivity.this, RechaSuccActivity.class);
        ...
        confirmOrderAdapter.setEditTextString(new ConfirmOrderAdapter.editTextString() {
            ...
            public void getString(String content, int storeId, String mesaagesCartId) {
                try {
                    ...
                    Log.d("ConfirmOrderWorkActivity", jsonMessage.toString());
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.confirm_order_addrss_rl:
                //选择收货地址
                Intent intent = new Intent(context, SelectAddrssWorkActivity.class);
                intent.putParcelableArrayListExtra("address", beanList);
                startActivityForResult(intent, 1);
                break;
            case R.id.confirm_order_addrss_rl2:
                //选择收货地址
                Intent intent2 = new Intent(context, SelectAddrssWorkActivity.class);
    ...
    private void requestForAli(JSONObject dataObj) {
        ...
        Runnable payRunnable = new Runnable() {
            @Override
            public void run() {
                PayTask alipay = new PayTask(ConfirmOrderWorkActivity.this);
