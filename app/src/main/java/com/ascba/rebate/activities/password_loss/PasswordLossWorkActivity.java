...
public class PasswordLossWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        ...
        Intent intent=new Intent(PasswordLossWorkActivity.this, PasswordLossWithCodeWorkActivity.class);
