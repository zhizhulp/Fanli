...
import com.ascba.rebate.utils.baidumap.PoiOverlay;
    ...
    *//**
    ...
    public void onGetPoiDetailResult(PoiDetailResult result) {
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            ...
            Toast.makeText(PoiSearchDemo.this, result.getName() + ": " + result.getAddress()+" : latitude-->" +latitude+" : longitude-->" +longitude, Toast.LENGTH_SHORT)
                    .show();
        }
    }
  ...
  /*  *//**
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (location != null) {
                ...
                if (location.getCity() != null
                    ...
                    keyWorldsView.setText(location.getAddrStr());
    ...
    public void loadLocation() {
        ...
        if (locationClient == null) {
            locationClient = new LocationClient(PoiSearchDemo.this);
