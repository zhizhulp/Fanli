...
import com.ascba.rebate.activities.me_page.settings.child.personal_data_child.AgeChangeWorkActivity;
import com.ascba.rebate.activities.me_page.settings.child.personal_data_child.LocationWorkActivity;
import com.ascba.rebate.activities.me_page.settings.child.personal_data_child.ModifyNicknameWorkActivity;
import com.ascba.rebate.activities.me_page.settings.child.personal_data_child.SexChangeWorkActivity;
...
public class PersonalDataWorkActivity extends BaseNetWorkActivity implements View.OnClickListener, BaseNetWorkActivity.Callback {
    ...
    public void personalNickNameChange(View view) {
        Intent intent = new Intent(this, ModifyNicknameWorkActivity.class);
    ...
    public void personalSexChange(View view) {
        if (isCardId == 1) {
            ...
            Intent intent = new Intent(this, SexChangeWorkActivity.class);
    ...
    public void personalLocationChange(View view) {
        if (isCardId == 1) {
            ...
            Intent intent = new Intent(this, LocationWorkActivity.class);
    ...
    public void personalAgeChange(View view) {
        if (isCardId == 1) {
            ...
            Intent intent = new Intent(this, AgeChangeWorkActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case sexRequest:
                ...
                switch (resultCode) {
                    case SexChangeWorkActivity.SELECT_MAN:
                        sexShow.setText("男");
                        break;
                    case SexChangeWorkActivity.SELECT_WOMAN:
                        sexShow.setText("女");
                        break;
                    case SexChangeWorkActivity.SELECT_PRI:
                        sexShow.setText("保密");
                        break;
                }
                break;
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        if (finalScene == 0) {
            ...
            Picasso.with(PersonalDataWorkActivity.this).load(UrlUtils.baseWebsite + avatar).error(R.mipmap.logo).noPlaceholder().into(userIconView);
            ...
            Toast.makeText(PersonalDataWorkActivity.this, message, Toast.LENGTH_SHORT).show();
        }
