...
import com.ascba.rebate.activities.me_page.user_update_child.OpenProxyWorkActivity;
...
public class UserUpdateWorkActivity extends BaseNetWorkActivity implements
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        if(finalScene==1){
            ...
            if(isCardId==0){
                ...
                dm.setCallback(new DialogManager.Callback() {
                    ...
                    public void handleSure() {
                        dm.dismissDialog();
                        Intent intent=new Intent(UserUpdateWorkActivity.this,RealNameCofirmWorkActivity.class);
            ...
            Intent intent=new Intent(UserUpdateWorkActivity.this, OpenProxyWorkActivity.class);
