...
public class TakeDetailsWorkActivity extends BaseNetWorkActivity implements SuperSwipeRefreshLayout.OnPullRefreshListener, BaseNetWorkActivity.Callback, View.OnClickListener {
