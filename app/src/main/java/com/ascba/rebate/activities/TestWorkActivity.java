...
public class TestWorkActivity extends BaseNetWorkActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setCallback(new Callback() {
            ...
            public void handle200Data(JSONObject dataObj, String message) {
                ...
                Log.d("TestWorkActivity", "Callback-->" + message);
            }
        ...
        setCallbackWhat(new CallbackWhat() {
            ...
            public void handle200Data(int what, JSONObject dataObj, String message) {
                Log.d("TestWorkActivity", "what-->" + what + "Callback-->" + message);
            }
    ...
    protected void mhandle200Data(int what, JSONObject object, JSONObject dataObj, String message) {
        Log.d("TestWorkActivity", "200:" + "what-->" + what + "##object-->" + object);
    }
