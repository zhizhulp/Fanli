 ...
 * 商户中心，输入公司名称
 */
public class BCInputNameWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        ...
        Intent intent = new Intent(this, BusinessCenterWorkActivity.class);
        if (is_oper_name == 1) {
