...
public class RegisterInputNumberWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
...
//        StatusBarUtil.setColor(this, 0xffe52020);
    ...
    public void goServerProtocol(View view) {
        Intent intent = new Intent(this, RegisterProtocolWorkActivity.class);
    ...
    public void handle200Data(JSONObject dataObj, String message) {
        ...
        Intent intent = new Intent(RegisterInputNumberWorkActivity.this, RegisterAfterReceiveCodeWorkActivity.class);
