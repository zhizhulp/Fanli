...
public class ShopMessageWorkActivity extends BaseNetWorkActivity {
    ...
    public static void startIntent(Context context) {
        Intent intent = new Intent(context, ShopMessageWorkActivity.class);
        ...
        recyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                switch (position) {
                    ...
                    case 1:
                        //系统通知
                        MessageDetailsWorkActivity.startIntent(context);
                        break;
                }
            }
        });
