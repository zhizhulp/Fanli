...
public class BusiFlowRecordsActivity extends BaseNetActivity implements
        ...
        if(what==0){
            ...
            if(array!=null && array.length()!=0){
                for (int i = 0; i < array.length(); i++) {
                    ...
                    ca.setImgUrl(UrlUtils.getNewUrl(object1.optString("img")));
                    data.add(ca);
                }
            ...
            if(array!=null && array.length()!=0){
                for (int i = 0; i < array.length(); i++) {
                    ...
                    ca.setImgUrl(UrlUtils.getNewUrl( object1.optString("pic")));
                    data.add(ca);
                }
                adapter.notifyDataSetChanged();
            }
    ...
    private void requestNet(){
        if(type==0){
            ...
            requestNetwork(UrlUtils.dateMerchantWaterLog);
        }
    }
}
