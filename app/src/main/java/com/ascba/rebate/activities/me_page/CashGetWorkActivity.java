 ...
 * 财富-现金账户-提现
 */
public class CashGetWorkActivity extends BaseNetWorkActivity implements View.OnClickListener, BaseNetWorkActivity.Callback
,MoneyBar.CallBack{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.when_no_card:
                Intent intent = new Intent(this, AddCardWorkActivity.class);
                ...
                if (isCardId == 0) {
                    ...
                    dm.setCallback(new DialogManager.Callback() {
                        ...
                        public void handleSure() {
                            Intent intent = new Intent(CashGetWorkActivity.this, RealNameCofirmWorkActivity.class);
                            startActivity(intent);
                            finish();
                        }
                    });
                    ...
                    dm.setCallback(new DialogManager.Callback() {
                        @Override
                        public void handleSure() {
                            Intent intent = new Intent(CashGetWorkActivity.this, AddCardWorkActivity.class);
                            intent.putExtra("realname", realname);
                            startActivity(intent);
                            finish();
                        }
...
//        startActivity(intent);
        TransactionRecordsWorkActivity.startIntent(this);
    }
