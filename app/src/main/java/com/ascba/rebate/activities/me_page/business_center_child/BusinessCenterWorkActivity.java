 ...
 * 商户中心 商户资料提交页面
 */
public class BusinessCenterWorkActivity extends BaseNetWorkActivity implements BaseNetWorkActivity.Callback {
    ...
    public void uploadWorkPic(View view) {
        if(finalType==-1||finalType==1){
            ...
            Intent intent=new Intent(this,ShowPicWorkActivity.class);
            if(chartered!=null){
        ...
        if(type==0){//显示营业执照
            ...
            smWorkPic.setCallback(new SelectIconManager.Callback() {
                ...
                public void clickCamera() {
                    ...
                    if(Build.VERSION.SDK_INT>23){//处理7.0的情况
                        Uri uri = FileProvider.getUriForFile(BusinessCenterWorkActivity.this, "com.ascba.rebate.provider", fileWork);
            ...
            smAuthPic.setCallback(new SelectIconManager.Callback() {
                ...
                public void clickCamera() {
                    ...
                    if(Build.VERSION.SDK_INT>23){//处理7.0的情况
                        Uri uri = FileProvider.getUriForFile(BusinessCenterWorkActivity.this, "com.ascba.rebate.provider", fileAuth);
                        intent.putExtra(MediaStore.EXTRA_OUTPUT, uri);
