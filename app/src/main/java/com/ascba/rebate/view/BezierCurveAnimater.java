...
/**
 * Created by 李鹏 on 2017/04/07 0007.
 */

public class BezierCurveAnimater {
    ...
    private ViewGroup rl;//父布局
    private View cart;//购物车

    public BezierCurveAnimater(Context context, ViewGroup rl, View cart) {
