...
public class UrlUtils {
    ...
    public static final String baseWebsiteChange = "http://home.qlqwshop.com";//p2p改为shop
    ...
    public static final String auctionCard = urlPrefix + "auctionCard";//竞拍购物车列表(待支付保证金)
