 ...
 * 带有缓存功能
 */
public class BaseCacheFragment extends Fragment {
    ...
    private class NetResponseListener implements OnResponseListener<JSONObject> {
        ...
        public void onSucceed(int what, Response<JSONObject> response) {
            ...
            Log.d("NetResponseListener", "response.isFromCache():" + response.isFromCache());
            ...
            try {
                ...
                if (status == 200) {
                    ...
                    startActivityForResult(intent, BaseNetActivity.REQUEST_LOGIN);
