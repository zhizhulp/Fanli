...
import com.ascba.rebate.adapter.ShopAdapter;
...
public class ShopMainFragment1 extends BaseNetFragment implements BaseNetFragment.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.shop_main_fragment, null);
    }
    ...
    private void initViews(View view) {
        rv = ((XRecyclerView) view.findViewById(R.id.list_clothes));
    ...
    private void getPage(JSONObject dataObj) {
    ...
    private void initadapter() {
        ...
        //    rv.addItemDecoration(new DividerGridItemDecoration(getActivity(),mySpanSizeLookUp,getResources().getColor(R.color.main_bg)));
            ...
            //shopAdapter.setEmptyView(ViewUtils.getEmptyView(getActivity(),"暂无信息"));
        } else {
            shopAdapter.notifyDataSetChanged();
        }
    }
    ...
    private void showStandardDialog(List<GoodsAttr> gas, List<Goods> goodses,Goods defaultGoods) {
        ...
        sd.setListener(new StdDialog.Listener() {
            ...
            public void isSelectAll(boolean isAll) {
                ShopMainFragment1.this.isAll = isAll;
            }
        });
        //点击加号
