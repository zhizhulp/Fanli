   ...
   */
    ...
    private void initData(JSONObject dataObj) {
        ...
        if (jsonArray != null && jsonArray.length() > 0) {
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                OrderBean beanHead = new OrderBean(DeliverOrderAdapter.TYPE1, R.layout.item_order_head, time, "等待买家收货");
                ...
                OrderBean beadFoot = new OrderBean(DeliverOrderAdapter.TYPE3, R.layout.item_order_take_foot, goodsNum, "￥" + orderAmount, shippingFee);
    ...
    private List<OrderBean> getData() {
        ...
        for (Goods goods : goodsList) {
            OrderBean beanGoods1 = new OrderBean(DeliverOrderAdapter.TYPE2, R.layout.item_goods, goods);
         ...
         */
        for (Goods goods : goodsList) {
            OrderBean beanGoods2 = new OrderBean(DeliverOrderAdapter.TYPE2, R.layout.item_goods, goods);
